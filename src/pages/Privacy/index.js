  ...
  <div className="Privacy wrapper">
    <Helmet>
  	...
  	<div id='ppBody'>
  		...
  		<div className='ppConsistencies'>
  			...
  			<div className='col-2'>
  				<div className="col-12 quick-links2 gen-text-center">
  					...
  					<div className="col-8 gen-text-left gen-xs-text-center" style={{ fontSize: '12px', position: 'relative', left: '20px' }}>Fair information<br /> Practices</div>
  				</div>
  			</div>
  			<div className='col-2'>
  		...
  		<br />
  		<div className='innerText'>We collect information from you when you place an order, subscribe to a newsletter or enter information on our site.</div>
  		...
  		<div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To send periodic emails regarding your order or other products and services.</div>
  		...
  		<div className='innerText'>We use regular Malware Scanning.<br /><br /></div>
  		...
  		<div className='innerText'><br /><strong>Opting out:</strong><br />
  		...
  		<div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Follow the instructions at the bottom of each email.</div>
  	...
  	<div className='innerText'>driebroek.nl</div>
  	<div className='innerText'>Aan t Verlaat 33C</div>
  	Delft, Zuid Holland 2612XW
  	<div className='innerText'>Nederland</div>
  	<div className='innerText'>support@driebroek.nl</div>
  	<div className='innerText'><br />Last Edited on 2017-09-11</div>
  </div>
)
